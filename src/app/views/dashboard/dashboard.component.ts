...
export class DashboardComponent implements OnInit {
  ...
  public barChartData: any[] = [
    { data: [65, 59, 80, 81, 56, 55, 40], label: 'Mensagens Recebidas' },
    { data: [28, 48, 40, 19, 86, 27, 90], label: 'Mensagens Tratadas' }
  ];
  ...
  // Doughnut
  public doughnutChartLabels: string[] = ['Áudio', 'Imagem', 'Texo', 'Vídeo'];
  public doughnutChartData: number[] = [250, 150, 500, 100];
